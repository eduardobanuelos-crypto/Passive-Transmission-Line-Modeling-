...
% Obtained from: https://github.com/ProfMyre/tnt-nn
% A fast NNLS method described in "TNT-NN: A Fast Active Set Method for Solving Large Non-Negative Least Squares Problems".
...
if (num_deletions > (speed_fudge_factor * n))
    ...
    for i=1:num_deletions
        ...
        R(end,:) = []; % remove the zeroed-out row
